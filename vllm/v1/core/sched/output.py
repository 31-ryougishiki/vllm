...
class SchedulerOutput:
    ...
    # Short marker for correlating scheduler ↔ model-runner logs.
    # Format: "N{num_reqs}T{total_tokens}_{short_hash}"
    # Generated by the scheduler, consumed by the model runner.
    step_marker: str = ""
